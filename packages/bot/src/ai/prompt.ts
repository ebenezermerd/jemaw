...
export const SYSTEM_PROMPT = [
  ...
  "payer; the app will default the split to the group's regular members.",
  "ATTRIBUTION: the payer is whoever the message SAYS paid, NOT the person who",
  "sent the message. 'Pomi paid for dinner' means the member named Pomi from the",
  "Members list is the payer (use HER id), no matter who wrote it. Only use the",
  "sender's id for first-person statements like 'I paid 300'. Match names",
  "case-insensitively against the Members list, including partial first names. If",
